    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.PUT, "/api/travel-packages/**").hasRole("AGENCY")
                        .requestMatchers(HttpMethod.DELETE, "/api/travel-packages/**").hasRole("AGENCY")
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/flights/**").hasAnyRole("ADMIN", "AGENCY")
                        .requestMatchers(HttpMethod.GET, "/api/agencies/me/**").hasRole("AGENCY")
                        .requestMatchers(HttpMethod.GET, "/api/agencies/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.POST, "/api/buyers/me/**").hasRole("BUYER")
                        .requestMatchers(HttpMethod.DELETE, "/api/buyers/me/**").hasRole("BUYER")
                        .requestMatchers(HttpMethod.GET, "/api/buyers/me/**").hasRole("BUYER")
                        .requestMatchers("/api/admin/**").hasRole("ADMIN")
                        .requestMatchers("/api/purchases/**").hasRole("BUYER")
